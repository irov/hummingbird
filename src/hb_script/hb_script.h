...
hb_result_t hb_script_initialize( const hb_db_client_handle_t * _client, size_t _memorylimit, size_t _calllimit, const hb_oid_t _puid, const hb_oid_t _uuid, hb_matching_t * _matching, hb_script_handle_t ** _handle );
