...
//////////////////////////////////////////////////////////////////////////
hb_result_t hb_http_get_request_json( struct evhttp_request * _request, void * _pool, hb_size_t _capacity, hb_json_handle_t ** _handle )
{
    ...
    if( hb_json_create( data, data_size, _pool, _capacity, _handle ) == HB_FAILURE )
    {
        return HB_FAILURE;
    }
