...
hb_result_t hb_node_write_in_data( hb_sharedmemory_handle_t * _sharedmemory, void * _in, size_t _size, uint32_t _magic, uint32_t _version );
...
hb_result_t hb_node_write_out_data( hb_sharedmemory_handle_t * _sharedmemory, void * _in, size_t _size, uint32_t _magic, uint32_t _version );
