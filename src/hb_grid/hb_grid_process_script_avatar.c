...
//////////////////////////////////////////////////////////////////////////
hb_result_t hb_grid_process_script_avatar( hb_grid_process_handle_t * _process, const hb_grid_process_script_avatar_in_data_t * _in, hb_grid_process_script_avatar_out_data_t * _out )
{
    ...
    if( hb_script_initialize( HB_DATA_MAX_SIZE, HB_DATA_MAX_SIZE, token_handle.poid, token_handle.uoid, _process->matching, &script_handle ) == HB_FAILURE )
    {
    ...
    if( hb_script_avatar_call( script_handle, _in->method, _in->data, _in->data_size, _out->response_data, HB_GRID_REQUEST_DATA_MAX_SIZE, &_out->response_size, &code ) == HB_FAILURE )
    {
        return HB_FAILURE;
    }
